...
class MemberAccessTokenGroup extends ExpressionTokenGroup
{
    use FlattenFunction;

    public function __construct(
        public string|Token|VariableTokenGroup|PropertyTokenGroup $subject,
        ...
        parent::__construct([$this->subject, new MemberAccessToken(), $this->member]);
    }
}
